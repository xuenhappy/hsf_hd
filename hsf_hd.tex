...
\begin{quote}我们常常犯一个直觉上的错误，以为“红色”是涂在“苹果”表面的颜料，仿佛它们是可以剥离的皮与肉。但在我们的理论框架中，这种分离并不存在。\end{quote}
...
\begin{quote}长期以来，这被视为神秘主义的呓语。但在我们的几何视域下，这句话是对宇宙拓扑结构最精确的描述。\end{quote}
...
\vspace{1em}让我们从这里开始，推导智慧的第一性原理。
