...
\section{形元 \texorpdfstring{($V_S$)} —— 空间的编译指令集}
...
\section{主观的风向：规范势 ($\mathcal{A}_\mu$) 的引入}
...
\section{微观注入机制：从源流 ($\vec{J}_{ext}$) 到语义子 (Semantion)}
...
在波动视域下，TECI 循环不再是“射击”，而更像是 \textbf{“相控阵雷达”} 的运作：
