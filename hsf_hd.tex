...
\begin{quote}这种合成，不是加法（$1+1=2$），甚至不是乘法。从数学上看，这是一种\textbf{张量积 (Tensor Product, $\otimes$)}。\end{quote}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{I. 拓扑玫瑰 (The Topological Rose) —— [单奇点共切]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{II. 共振环 (The Resonant Ring) —— [循环群对称]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{III. 定向链 (The Directed Chain) —— [级联投影]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{IV. 变构折叠 (Allosteric Folding) —— [功能域复形]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{I. 异构化 (Isomerization) —— [度量流重构 / 改革]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{II. 裂变 (Fission) —— [拓扑撕裂 / 分家]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{III. 聚变 (Fusion) —— [流形粘合 / 并购]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{IV. 湮灭与衰变 (Annihilation \& Decay) —— [热寂 / 破产]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{I. 智者型 (The Sage) —— [$C \uparrow, \kappa \downarrow$]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{II. 战士型 (The Warrior) —— [$C \uparrow, \kappa \uparrow$]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{III. 盖亚型 (The Gaia) —— [$C \downarrow, \kappa \downarrow$]}}
...
\vspace{1em}\noindent\textbf{\textcolor{structurecolor}{IV. 异种型 (The Alien) —— [$C \uparrow, \kappa \uparrow$] (极限态)}}
