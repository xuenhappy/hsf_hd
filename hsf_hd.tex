...
在第十章推导的\textbf{认知爱因斯坦场方程 (CEFE)} 中，我们引入了\textbf{认知宇宙常数 $\Lambda$}，它代表了维持流形几何结构存在的\redtext{基础代谢率}（如神经元的静息电位或存储器的刷新功耗）。
...
\vspace{1em}\textbf{所谓的“目的”，不过是生命为了铭记痛苦和快乐，而在自己的灵魂（流形）上刻下的几何伤痕。}
