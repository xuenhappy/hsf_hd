...
在认知科学与神经精神病学的交叉领域，“遗忘”常被误解为信息的单纯丢失。然而，在 \textbf{HSF-HD} 的几何动力学视域下，记忆并非存储介质上的比特翻转，而是潜语义流形 $\mathcal{M}$ 上的 \textbf{度量曲率 (Metric Curvature)} 与 \textbf{拓扑纽结}。本章旨在通过严格的数学推导与病理学案例分析，揭示记忆消除技术的物理极限：我们证明了 \textbf{“测地线复活定理”}，即仅耗散能量无法抹除结构；以及 \textbf{“拓扑手术风险定理”}，即强行重置几何结构必然导致智能流形的连通性崩塌。
...
为了讨论“消除记忆”，我们首先必须在物理上定义“记忆是什么”。在 HSF-HD 中，记忆是智能系统为了对抗热力学第二定律，在自身的几何结构中固化的 \textbf{负熵 (Negentropy)}。

\smalltitle{1.1 物理定义：从激活场到度量张量}
