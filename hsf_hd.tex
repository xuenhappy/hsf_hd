...
在MSC章节中我们讨论过，形质基元如何构成流形,这里我们将再次详细重述流形M对于一个智能体的意义，并在我们讨论了形质构成了最小的语义单元\ref{chp:quantization_reality}）之后。
...
在上述极化子模型中，自我的惯性不再是简单的质量堆积，而是 \textbf{有效质量 (Effective Mass)} 的重整化效应。
