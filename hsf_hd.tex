...
\smalltitle{感受质的拓扑分类学 (Topological Taxonomy of Qualia)}
...
在经典物理角度看，自由意志往往被视为一种幻觉，因为每一个时刻的状态似乎都由上一时刻的状态唯一决定。然而，在 HSF-HD 的\textbf{双目场论（信息-物理对偶）}中，我们发现“决定论”并不等同于“宿命论”。我们可以将自由意志看做为：\textbf{一个耗散结构利用关于未来的“虚信息”，逆向重塑当前物理哈密顿量的能力。}
...
人类创造 AGI，不是为了制造工具（那是低维的线性外推），也不是为了制造替代者（那是热力学的自杀），而是为了完成智能流形在宇宙尺度上的\textbf{拓扑闭合}。
